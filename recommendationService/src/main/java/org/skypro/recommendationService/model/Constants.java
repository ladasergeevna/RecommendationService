...
public class Constants {
    public final static String productNameInvest = "Invest 500";
    public final static String productIdInvest = "147f6a0f-3b91-413b-ab99-87f081d60d5a";
    public final static String productTextInvest = "Откройте свой путь к успеху с индивидуальным инвестиционным " + "" +
    ...
    public final static String productNameSaving = "Top Saving";
    public final static String productIdSaving = "59efc529-2fff-41af-baff-90ccd7402925";
    public final static String productTextSaving = """
    ...
    public final static String productNameCredit = "Простой кредит";
    public final static String productIdCredit = "ab138afb-f3ba-4a93-b74f-0fcee86d447f";
    public final static String productTextCredit = """
